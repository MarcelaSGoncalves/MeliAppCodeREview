...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func createFavoritesNavigationController() -> UINavigationController {
        ...
        favoritesNavigationController.tabBarItem = UITabBarItem(title: "Favorites", image: UIImage(systemName: "heart"), tag: 0)
    ...
    func createTabBar() -> UITabBarController {
        ...
        UITabBar.appearance().tintColor = UIColor(named: "CTAs")
        tabBar.viewControllers = [createHomeNavigationController(),createFavoritesNavigationController()]
        return tabBar
    }
